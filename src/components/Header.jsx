    ...
    <div className="relative md:w-[80%] md:relative">
      ...
      <div  className={`bg-[hsl(243,23%,30%)] w-[54%] md:w-[20%] md:absolute md:left-[77%]  rounded-lg px-4 py-4 font-dmSans absolute left-[46%] top-[110%] md:z-[10] transition-all ease-in ${viewDropDown?'block':'hidden'} `}>
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-white mt-3 font-medium flex justify-between items-center transition-all ease-in hover:bg-neutral-400 hover:rounded-lg border-2 border-transparent py-2 px-2" onClick={()=>
          ...
          <span className="transition-all ease-in font-medium text-white mt-3 pb-3 border-b-1 border-b-neutral-500 flex justify-between items-center hover:bg-neutral-400 hover:rounded-lg border-2 border-transparent py-2 px-2" onClick={()=>{
            setSelectedTemperature((curStatus)=>!curStatus)
        ...
        <div className="flex flex-col">
          ...
          <span className="text-white transition-all ease-in mt-3 pb-2 border-b-1 font-medium border-b-neutral-500 flex justify-between items-center hover:bg-neutral-400 hover:rounded-lg border-2 border-transparent py-2 px-2" onClick={()=>
            {setSelectedWindSpeed((curStatus)=>!curStatus)
        ...
        <div className="flex flex-col">
          ...
          <span className="text-white transition-all ease-in mt-3 font-medium flex items-center justify-between hover:bg-neutral-400 hover:rounded-lg border-2 border-transparent py-2 px-2" onClick={()=>{
          ...
          <span className="text-white transition-all ease-in mt-3 pb-2 font-medium flex items-center justify-between hover:bg-neutral-400 hover:rounded-lg border-2 border-transparent py-2 px-2" onClick={()=>{
            setSelectedPrecipitation((curStatus)=>!curStatus)
