    ...
    return (
        <div className="bg-neutral-800 mt-2 rounded-md h-[80vh] overflow-y-scroll scroll-smooth relative md:w-[100%] md:h-[98%]  md:rounded-[10px] md:mt-4 md:relative">
                ...
                <div className="flex justify-between items-start py-4 px-2 ">
                   ...
                   : <ul className="text-white px-5 py-2" onClick={(e)=>handleWeekDays(e)}>
                    <li className="mb-2">Monday</li>
                    <li className="mb-2">Tuesday</li>
                    <li className="mb-2">Wednesday</li>
                    <li className="mb-2">Thursday</li>
                    <li className="mb-2">Friday</li>
                    <li className="mb-2">Saturday</li>
