        ...
        <div className="bg-neutral-800 mt-2 rounded-2xl h-[90vh] mb-[5px]  relative md:w-[100%] md:h-[98%]  md:rounded-2xl md:mt-4 md:relative">
                ...
                <div  className="flex justify-between items-start py-4 px-2 ">
                   ...
                   : <ul data-testid="weekdays" className="text-white px-5 py-2 z-[7]" onClick={(e)=>handleWeekDays(e)}>
                    ...
                    <li className="mb-2 hover:bg-neutral-400 border-1 border-transparent px-2 hover:rounded-md transition-all ease-in">Thursday</li>
                    <li className="mb-2 hover:bg-neutral-400 border-1 border-transparent px-2 hover:rounded-md transition-all ease-in">Friday</li>
                    <li className="mb-2 hover:bg-neutral-400 border-1 border-transparent px-2 hover:rounded-md transition-all ease-in">Saturday</li>
                    <li className="mb-2 hover:bg-neutral-400 border-1 border-transparent px-2 hover:rounded-md transition-all ease-in">Sunday</li>
            ...
            <ul className="px-4 z-[4] md:mb-50  absolute top-[12%] h-[85%]  md:h-[85%] overflow-y-scroll box-border md:box-border scroll-smooth scrollbar-thumb-gray-950 scrollbar-thumb-rounded-lg custom-thumb-size scrollbar-w-1 scrollbar">
